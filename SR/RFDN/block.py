...
def activation(act_type, inplace=True, neg_slope=0.05):
...
def conv_block(in_nc, out_nc, kernel_size, stride=1, dilation=1, groups=1, bias=True, act_type='relu'):
